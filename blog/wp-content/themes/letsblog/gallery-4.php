...
global $lestblog_page_gallery_id;
if(!empty($lestblog_page_gallery_id))
{
	$current_page_id = $lestblog_page_gallery_id;
}
	...
	<?php
	    ...
	    foreach($all_photo_arr as $key => $photo_id)
	    {
	        ...
	        if(!empty($photo_id))
	        {
	        	...
	        	$small_image_url = wp_get_attachment_image_src($photo_id, 'letsblog_gallery_grid', true);
	        }
