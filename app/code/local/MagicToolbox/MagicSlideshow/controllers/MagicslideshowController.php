...
class MagicToolbox_MagicSlideshow_MagicslideshowController extends Mage_Adminhtml_Controller_Action {
    ...
    public function addAction() {
        ...
        if($data = $this->getRequest()->getPost()) {
            ...
            $defaultValues = serialize(Mage::helper('magicslideshow/params')->getDefaultValues());
    ...
    public function saveAction() {
        ...
        if($post = $this->getRequest()->getPost()) {
            ...
            if(isset($post['magicslideshow']['customslideshowblock']['gallery'])) {
                $images = Mage::helper('core')->jsonDecode($post['magicslideshow']['customslideshowblock']['gallery']);
                ...
                $post['magicslideshow']['customslideshowblock']['gallery'] = Mage::helper('core')->jsonEncode($images_to_save);
            }
            ...
            */
            ...
            $data = array();
            $data['value'] = serialize($post['magicslideshow']);
